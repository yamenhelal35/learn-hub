...
const Courses = () => {
  ...
  <div className="flex flex-col items-center justify-center space-y-6 md:space-y-10">
    ...
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 ml-64">
    <div className="w-full sm:w-auto md:w-auto lg:w-auto xl:w-auto"> 
      ...
      </div><div className="group relative rounded-lg border border-gray-800 bg-gray-950 shadow-sm transition-all duration-300 hover:border-gray-700 hover:shadow-md">
        <div className="aspect-w-16 aspect-h-9 overflow-hidden rounded-t-lg">
          <img
            alt="Course Thumbnail"
            className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
